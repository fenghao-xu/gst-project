 ...
 */
public interface StyleSewingCraftStdDao {
    ...
    List<CraftFile> getBigStyleCraftStdFileNewCraft(@Param("styleRandomCode") Long styleRandomCode);

    @MapKey("remark")
    Map<String,CraftStd> getBigStyleCraftStdMap(@Param("styleRandomCode") Long styleRandomCode, @Param("isNew") Boolean isNew);
}
