...
//        return emps;
//    }
    public static ResponseEntity<byte[]> exportCraftCategory2Excel(List<CraftCategory> craftCategories) {
        return null;
    }

    public static List<CraftCategory> importCraftCategory2List(MultipartFile file) {
        return null;
    }
}